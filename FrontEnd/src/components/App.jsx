...
function App() {
  ...
  return (
    ...
    bg-${color}-500 hover:bg-amber-200 hover:text-amber-700">
      ...
      <button className="w-40 rounded-lg p-3 m-2 font-bold transition-all duration-100 border-2 active:scale-[0.98]
    bg-${color}-500 hover:bg-amber-500 hover:text-white">
        Sign Up
      </button>
      </div>
